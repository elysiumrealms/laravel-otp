                                    ...
                                    <td align="center">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" role="presentation"
                                            ...
                                            <tr>
                                                ...
                                                <![endif]-->
                                                    <span
                                                        style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;">
                                                        {{ $otp }}
                                                    </span>
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                                ...
                                                                @if (config('mail.instagram_url') != '')
                                                                    <table border="0" align="center"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center">
                                                                                <a
                                                                                    href="{{ config('mail.facebook_url') }}"><img
                                                                ...
                                                                @if (config('mail.instagram_url') != '')
                                                                    <table border="0" align="center"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center">
                                                                                <a
                                                                                    href="{{ config('mail.instagram_url') }}"><img
                                                                                        style="width:36px;border:0px;display: inline!important;"
                                                                ...
                                                                @if (config('mail.twitter_url') != '')
                                                                    <table border="0" align="center"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center">
                                                                                <a
                                                                                    href="{{ config('mail.twitter_url') }}"><img
                                                                                        style="width:36px;border:0px;display: inline!important;"
                                                                ...
                                                                @if (config('mail.pinterest_url') != '')
                                                                    <table border="0" align="center"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center">
                                                                                <a
                                                                                    href="{{ config('mail.pinterest_url') }}"><img
                                                                                        style="width:36px;border:0px;display: inline!important;"
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <a href="tel:{{ config('mail.phone_number') }}"
                                            style="color:#6e6e6e;"><span>{{ config('mail.phone_number') }}</span></a>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <a href="mailto:{{ config('mail.info_email') }}" style="color:#6e6e6e;">
                                            <span>{{ config('mail.info_email') }}</span>
                                        </a> - <a href="{{ url('/') }}" style="color:#6e6e6e;">
                                ...
                                <tr>
                                    <td align="center">
                                        @if (config('mail.play_url') != '' || config('mail.ios_url') != '')
                                            <!-- Buttons -->
                                            <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <table border="0" align="center" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{ config('mail.ios_url') }}"><img
                                                                ...
                                                                <td align="center">
                                                                    <a href="{{ config('mail.play_url') }}"><img
                                                                            style="display:block;width:100%;max-width:117px;border:0px;"
                                                                            width="117"
